...
namespace Bamboo\ImportData\Base;

use Bamboo\ImportData\Exceptions\InvalidPackage;
use Carbon\Carbon;
...
abstract class MergeConfigServiceProvider extends ServiceProvider
{
...
abstract class PackageServiceProvider extends MergeConfigServiceProvider
{
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            foreach ($this->package->configFileNames as $configFileName) {
                $this->publishes([
                    $this->package->basePath("/../config/{$configFileName}.php") => $this->getConfigPath("{$configFileName}.php"),
